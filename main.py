...
def main():
    ...
    def compute_metrics(
        ...
        for group in GROUP_LIST:
            ...
            group_metrics[group] = compute_metrics_from_pred(input_r=input_r[group_mask], mean=means[group_mask],
                                                        stddev=stddevs[group_mask], pred_labels=pred_labels[group_mask],
        ...
        group_metrics['full_dataset'] = compute_metrics_from_pred(input_r=input_r, means=means, stddevs=stddevs,
